...
> = {
  greeting: [
    ...
    'hallo', 'goedendag', 'bonjour', 'salut', 'guten tag',
  ],
  treatment: [
    'recommend',
    'right treatment',
...
const treatmentTopics: readonly TreatmentTopic[] = [
  {
    ...
    aliases: [
      ...
      'konsültasyon', 'استشارة', 'ייעוץ', 'consultatie', 'consultation', 'Beratung',
    ],
  ...
  },
  {
    ...
    aliases: [
      ...
      'botox volledig gezicht', 'botox visage complet', 'Botox ganzes Gesicht',
    ],
  ...
  },
  {
    ...
    aliases: [
      ...
      'botox voorhoofd', 'botox front', 'Botox Stirn',
    ],
  ...
  },
  {
    ...
    aliases: [
      ...
      'filler onder ogen', 'filler sous les yeux', 'Filler unter den Augen',
    ],
  ...
  {
    id: 'cheek-filler',
    aliases: ['cheek filler', 'cheek fillers', 'филлер скул', 'elmacık dolgusu', 'حشو الخدود', 'מילוי לחיים', 'wangfiller', 'filler pommettes', 'Wangenfüller'],
  ...
  {
    id: 'jawline-filler',
    aliases: ['jawline filler', 'jaw filler', 'контур челюсти', 'çene hattı dolgusu', 'تحديد الفك', 'מילוי קו לסת', 'kaaklijn filler', 'filler mâchoire', 'Kieferfiller'],
  ...
  },
  {
    ...
    aliases: [
      ...
      'lipfiller', 'vollere lippen', 'filler lèvres', 'augmentation des lèvres', 'Lippenfüller', 'Lippenvergrößerung',
    ],
  ...
  {
    id: 'microneedling',
    aliases: ['microneedling', 'skinpen', 'acne scars', 'skin texture', 'large pores', 'მიკრონიდლინგ', 'микронидлинг', 'микроигольчат', 'mikroiğneleme', 'الميكرونידلينج', 'מיקרונידלינג', 'מיקרו-מחטים', 'acnelittekens', "cicatrices d'acné", 'Aknenarben'],
  ...
  {
    id: 'chemical-peel',
    aliases: ['chemical peel', 'ქიმიური პილინგ', 'химический пилинг', 'kimyasal peeling', 'التقشير الكيميائي', 'פילינג כימי', 'chemische peeling', 'peeling chimique', 'chemisches Peeling'],
  ...
  {
    id: 'skin-boosters',
    aliases: ['skin booster', 'skin boosters', 'скин-бустер', 'cilt canlandırıcı', 'معززات البشرة', 'מחזקי עור', 'huidbooster', 'booster de peau', 'Hautbooster'],
  ...
  {
    id: 'lash-lift',
    aliases: ['lash lift', 'lash lift tint', 'ламинирование ресниц', 'kirpik kıvırma', 'رفع الرموش', 'הרמת ריסים', 'wimperlift', 'rehaussement de cils', 'Wimpernlifting'],
  ...
  {
    id: 'brow-lamination',
    aliases: ['brow lamination', 'ламинирование бровей', 'kaş laminasyonu', 'فرد الحواجب', 'למינציית גבות', 'wenkbrauwlaminering', 'lamination des sourcils', 'Augenbrauenlaminierung'],
  ...
  {
    id: 'lashes',
    aliases: ['lashes', 'lash', 'eyelashes', 'წამწამ', 'ресниц', 'kirpik', 'رموش', 'ריסים', 'wimpers', 'cils', 'Wimpern'],
  ...
  },
  {
    ...
    aliases: [
      ...
      'gelmanicure', 'gelnagels', 'manucure gel', 'ongles en gel', 'Gel-Maniküre', 'Gelnägel',
    ],
  ...
  },
  {
    ...
    aliases: [
      ...
      'tırnak sanatı', 'فن الأظافر', 'אמנות ציפורניים', 'nagelkunst', 'décoration des ongles', 'Nagelkunst',
    ],
  ...
  {
    id: 'nails',
    aliases: ['nails', 'nail', 'manicure', 'ფრჩხილ', 'маникюр', 'ногт', 'manikür', 'tırnak', 'أظافر', 'مانيكير', 'ציפורניים', 'מניקור', 'nagels', 'pedicure', 'ongles', 'manucure', 'pédicure', 'Nägel', 'Maniküre', 'Pediküre'],
  ...
  {
    id: 'keratin',
    aliases: ['keratin', 'კერატინ', 'кератин', 'keratin', 'كيراتين', 'קרטין', 'keratine', 'kératine'],
