...
describe('Newsletter API', () => {
  ...
  it('allows same-origin JSON footer submissions without a token to reach validation', async () => {
  ...
  it('rejects cross-site newsletter submissions without a valid CSRF token', async () => {
    const response = await POST(
      newsletterRequest(
        { email: 'not-an-email' },
        {
