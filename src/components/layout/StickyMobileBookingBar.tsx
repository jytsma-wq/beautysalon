...
export function StickyMobileBookingBar() {
  ...
  return (
    <nav
      ...
      className="fixed inset-x-3 bottom-8 z-50 grid grid-cols-[1fr_auto_auto] overflow-hidden rounded-md border border-[#d9cec1] bg-white/95 shadow-[0_16px_44px_rgba(36,31,27,0.18)] backdrop-blur md:hidden"
    >
      <Link
        href="/book"
