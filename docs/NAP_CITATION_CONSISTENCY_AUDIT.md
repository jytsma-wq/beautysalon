...
signals were verified and should drive the next owner-approved cleanup:

| Source | Current finding | Required action | Approval |
| --- | --- | --- | --- |
...
The verified Google Maps profile URL is now the proposed first-party entity
identifier for `sameAs` and `hasMap` in the website's BeautySalon JSON-LD.
